            ...
            <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('products.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md transition">
                            Crear nuevo
                        </a>
                        <a href="{{ route('products.index') }}" class="bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md transition">
                            Ver todos
                        </a>
                    </div>
                </div>
