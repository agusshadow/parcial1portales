   ...
   <header>
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-center space-x-6">
                        ...
                        @if (Auth::check())
                            <a href="{{ route('orders.index') }}" class="hover:text-gray-300">Mis ordenes</a>
                        @endif
        ...
        <div class="md:hidden hidden px-2 pt-2 pb-3 space-y-1" id="mobile-menu">
            ...
            @if (Auth::check())
                <a href="{{ route('orders.index') }}" class="hover:text-gray-300">Mis ordenes</a>
            @endif
            <a href="{{ route('cart.index') }}" class="flex items-center px-3 py-2 rounded-md text-base font-medium hover:bg-gray-800">
