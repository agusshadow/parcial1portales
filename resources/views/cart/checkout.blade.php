                    ...
                    <div id="transfer-fields" style="display: none;">
                        <div class="mb-6 p-5 bg-gray-700 rounded-md">
                            ...
                            <div class="space-y-3 text-gray-200">
                                <div><span class="block text-xs text-gray-400">Titular de la cuenta</span><span class="block font-medium">Digital Games S.A.</span></div>
                                <div><span class="block text-xs text-gray-400">Banco</span><span class="block font-medium">Banco Nacional</span></div>
                                <div><span class="block text-xs text-gray-400">Número de Cuenta</span><span class="block font-medium">4567-8901-2345-6789</span></div>
                                <div><span class="block text-xs text-gray-400">CBU</span><span class="block font-medium">0000999988887777666655554444</span></div>
                                <div><span class="block text-xs text-gray-400">CUIT</span><span class="block font-medium">30-71234567-8</span></div>
                                <div><span class="block text-xs text-gray-400">Alias</span><span class="block font-medium">DIGITAL.GAMES.STORE</span></div>
                            </div>
                        </div>
...
<script>
    function togglePaymentForm() {
        ...
        document.getElementById('transfer-fields').style.display = paymentMethod === 'transfer' ? 'block' : 'none';
        toggleMercadoPagoButtonVisibility();
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (method === 'card') {
                if (!cardInput.value.trim() || !expiryInput.value.trim() || !cvvInput.value.trim()) {
                    e.preventDefault();
        ...
        nameInput.addEventListener('input', toggleMercadoPagoButtonVisibility);
