...
@section('title', 'GameStore - Tu tienda de juegos digitales')
...
@section('content')
    ...
    <div class="relative bg-gray-900 overflow-hidden">
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1552820728-8b83bb6b773f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Gaming setup">
        </div>
    </div>
    ...
    <div class="bg-gray-800 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-extrabold text-white text-center mb-8">Plataformas disponibles</h2>
            <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                <div class="flex flex-col items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition duration-300">
                    <i class="fab fa-steam text-4xl text-white mb-3"></i>
                    <span class="text-white font-medium">Steam</span>
                </div>
                <div class="flex flex-col items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition duration-300">
                    <i class="fab fa-playstation text-4xl text-white mb-3"></i>
                    <span class="text-white font-medium">PlayStation</span>
                </div>
                <div class="flex flex-col items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition duration-300">
                    <i class="fab fa-xbox text-4xl text-white mb-3"></i>
                    <span class="text-white font-medium">Xbox</span>
                </div>
                <div class="flex flex-col items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition duration-300">
                    <i class="fas fa-gamepad text-4xl text-white mb-3"></i>
                    <span class="text-white font-medium">Nintendo</span>
                </div>
                <div class="flex flex-col items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition duration-300">
                    <i class="fas fa-desktop text-4xl text-white mb-3"></i>
                    <span class="text-white font-medium">PC</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-12 bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-extrabold text-white text-center mb-8">Juegos Destacados</h2>
                ...
                <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-center mb-2">
                            <h3 class="text-xl font-bold text-white">Juego Ejemplo {{ $i }}</h3>
                            <span class="bg-indigo-600 text-white px-2 py-1 rounded text-sm">-20%</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <span class="text-white font-bold ml-2">$47.99</span>
                            </div>
                            <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1 rounded-md transition">Añadir</button>
                        </div>
                    </div>
                </div>
                @endfor
    ...
    <div class="py-12 bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-extrabold text-white">Ofertas Especiales</h2>
            ...
            <div class="bg-indigo-800 rounded-lg shadow-xl p-6 md:p-8 lg:flex lg:items-center lg:justify-between">
                <div>
                    <h3 class="text-2xl font-bold text-white">¡OFERTA FLASH!</h3>
                    <p class="mt-2 text-indigo-200">Obtén un 30% de descuento en todos los juegos de acción</p>
                    <p class="mt-4 text-white font-bold">Usa el código: <span class="bg-white text-indigo-800 px-2 py-1 rounded">ACTION30</span></p>
                </div>
